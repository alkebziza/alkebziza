...
## About Me
- Member of the **MicroRobot Research Club** at KAIST  
- **Project Leader** of the *Wall-Climbing Robot*  
  - Secured project funding (~₩400,000)  
  - Leading a team of 7 engineers  
- Strong interest in **robotics, startups, and manufacturing AI**
...
### Robotics
- Leading development of a **Wall-Climbing Robot** for KAIST Robot Show-Off  
- Responsible for concept design, team coordination, and execution  

### CAD & Product Design
- Designed:
  - Book stand  
  - **KAIST engraved phone stand**  
- Modeled using *RhinoCAD*:
  - AirPods Max  
  - Xiaomi Mouse  
  - Piston Cup  
  - Juicy Salif  
- Rendered projects using *KeyShot*  

### Engineering Internship
- **Technical Intern @ Sistronik Sistem (OHTL Engineering Company)**
  - Worked on **transmission tower design using AutoCAD**
  - Performed structural analysis & load calculations  
  - Participated in site inspections and assembly processes  
...
- Organized **50+ large-scale events** (competitions, cultural programs, tours)  
- Founded a **Merit Scholarship Fund**  
- Introduced digital tools (Canva Premium, Toddle) to improve education  

### Education Initiatives
- **Co-Founder — Students' League**
...
- MATLAB, Python  
- AutoCAD, Rhino, Fusion 360 (basic)  

**Tools & Tech**
- KeyShot, LaTeX, HTML, CSS  
